...
import { getFirestore, collection, doc, setDoc, onSnapshot, query, where } from 'firebase/firestore/lite';
  ...
  useEffect(() => {
    ...
    const unsub = onSnapshot(q, (querySnapshot) => {
      ...
      querySnapshot.forEach((doc) => {
        archiveTextList.push(doc.data());
      });
      // TO-DO: sorting of creation time
